...
trait Mixin
{
    ...
    private static function loadMixinTrait($trait)
    {
        ...
        foreach (self::getMixableMethods($context) as $name) {
            ...
            static::macro($name, function () use ($closureBase, $className) {
                // Sửa: thay vì sử dụng $this, tạo đối tượng mới từ static::class
    ...
    {
        return end(static::$macroContextStack) ?: new static(); // Sửa: trả về đối tượng mới nếu không có context
    }
}
