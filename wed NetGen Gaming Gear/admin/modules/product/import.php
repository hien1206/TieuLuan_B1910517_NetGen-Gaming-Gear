    ...
    if (in_array($file_ext, $allowed_ext)) {
        ...
        foreach ($data as $row) {
            if ($count > 0) {
                ...
                $sql_add = "INSERT INTO product(product_name, product_category, product_brand, capacity_id, product_price_import, product_price, product_sale, product_description, product_image, product_status) VALUE('" . $product_name . "', '0', '0', '0', '" . $product_price_import . "', '" . $product_price . "', '0', '" . $product_description . "', 'ruok.png', '0')";
